...
public class DependencyDescriptor extends InjectionPoint implements Serializable {
	...
	public boolean isRequired() {
		...
		if (this.field != null) {
			return !(this.field.getType() == Optional.class || hasNullableAnnotation() || (KotlinDetector.isKotlinReflectPresent()
	...
	public boolean equals(@Nullable Object other) {
		...
		return (this.required == otherDesc.required && this.eager == otherDesc.eager && this.nestingLevel == otherDesc.nestingLevel
		...
		try {
			if (this.fieldName != null) {
				...
				if (this.methodName != null) {
					this.methodParameter = new MethodParameter(this.declaringClass.getDeclaredMethod(this.methodName, this.parameterTypes),
															   this.parameterIndex);
				} else {
