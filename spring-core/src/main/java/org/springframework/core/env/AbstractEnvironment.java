...
public abstract class AbstractEnvironment implements ConfigurableEnvironment {
			...
			return (Map) new ReadOnlySystemAttributesMap() {
				...
				protected String getSystemAttribute(String attributeName) {
					try {
						...
						if (logger.isInfoEnabled()) {
							logger.info("Caught AccessControlException when accessing system environment variable '" + attributeName
										+ "'; its value will be returned [null]. Reason: " + ex.getMessage());
						}
						return null;
					}
	...
	public String toString() {
		return getClass().getSimpleName() + " {activeProfiles=" + this.activeProfiles + ", defaultProfiles=" + this.defaultProfiles + ", propertySources="
