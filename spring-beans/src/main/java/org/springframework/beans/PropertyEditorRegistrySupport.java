...
/**
 * 一个 {@link PropertyEditorRegistry} 接口的基础实现， 提供管理默认编辑器&自定义编辑器。主要服务于 {@link BeanWrapperImpl}
...
public class PropertyEditorRegistrySupport implements PropertyEditorRegistry {
	...
	private static final class CustomEditorHolder {
		...
		private PropertyEditor getPropertyEditor(@Nullable Class<?> requiredType) {
			...
			// for elements.)
			if (this.registeredType == null || (requiredType != null && (ClassUtils.isAssignable(this.registeredType, requiredType) || ClassUtils.isAssignable(
					requiredType, this.registeredType))) || (requiredType == null && (!Collection.class.isAssignableFrom(this.registeredType)
