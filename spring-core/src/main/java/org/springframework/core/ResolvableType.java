...
/**
 * <p>
 * spring core 包下提供的一个Java类型二次封装的一个类。
 * 继承了{@link java.lang.reflect.Type},主要是对Type 进行二次描述
 * 并针对方法，字段，参数，返回值等提供了一些列的方法
 * </p>
...
public class ResolvableType implements Serializable {
	...
	public boolean equals(@Nullable Object other) {
		...
		if (this.typeProvider != otherType.typeProvider && (this.typeProvider == null || otherType.typeProvider == null || !ObjectUtils.nullSafeEquals(
	...
	public static ResolvableType forMethodParameter(MethodParameter methodParameter, @Nullable ResolvableType implementationType) {
		...
		return forType(null, new MethodParameterTypeProvider(methodParameter), owner.asVariableResolver()).getNested(methodParameter.getNestingLevel(),
	...
	static ResolvableType forMethodParameter(MethodParameter methodParameter, @Nullable Type targetType, int nestingLevel) {
		...
		return forType(targetType, new MethodParameterTypeProvider(methodParameter), owner.asVariableResolver()).getNested(nestingLevel,
																														   methodParameter.typeIndexesPerLevel);
	}
	...
	private static final class SyntheticParameterizedType implements ParameterizedType, Serializable {
		...
		public boolean equals(@Nullable Object other) {
			...
			return (otherType.getOwnerType() == null && this.rawType.equals(otherType.getRawType()) && Arrays.equals(this.typeArguments,
