...
public interface MergedBeanDefinitionPostProcessor extends BeanPostProcessor {
	...
	/**
	 * 这里不单单是 merge beanDefinition 那么简单, 在spring 中有很多 metadata 对整个Bean构建的过程中起到了辅助的作用
	 * <p>
	 *     例如
	 * @see org.springframework.beans.factory.annotation.InjectionMetadata
	 * @see org.springframework.beans.factory.annotation.InitDestroyAnnotationBeanPostProcessor.LifecycleMetadata
	 * </p>
